    ...
    <div className='space-y-4 lg:flex lg'>
      ...
      <div className='lg:flex-1 lg:order-1'>
        ...
        <form action="" className='flex flex-col gap-4 md:flex-row'>
          <input className='rounded-md px-4 placeholder:text-gray-400' type="email" placeholder="Enter email address" />
          <button className='rounded-md px-4 py-3 bg-blue-400 hover:bg-blue-600 text-white'>Join Waitlist</button>
        </form>
        <div className='flex gap-2 '>
          <img src="./assets/Checkmark.svg" alt="Check" />
          <p className='font-lato text-gray-400'> No spam ever. Unsubsribe anytime.</p>
        </div>
      </div>
    </div>
  );
